...
<form action="<?= base_url(); ?>user/savedosen" method="POST" class="w-75" enctype="multipart/form-data">
    ...
    <div class="modal-footer">
        <a class="btn btn-secondary me-4" href="<?= base_url(); ?>user/daftardosen">Kembali</a>
