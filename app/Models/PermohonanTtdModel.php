...
class PermohonanTtdModel extends Model
{
    ...
    protected $allowedFields    = ['id_surat', 'id_dekanat', 'id_dosen', 'tanggal', 'kode_surat', 'perihal', 'jenis_surat', 'tujuan', 'prodi', 'nama_dosen', 'nik_dosen', 'kegiatan_keperluan', 'periode_awal', 'periode_akhir', 'sifat', 'tembusan', 'catatan', 'lampiran', 'no_urut', 'status', 'jenis_publikasi', 'keputusan', 'jumlah_matkul'];
